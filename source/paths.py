...
FILEPATHS_NUMPY_TEST = random.sample(FILEPATHS_NUMPY_GOOGLE_TEST, int(GOOGLE_TEST_SPLIT*len(FILEPATHS_NUMPY_GOOGLE_TEST))) + \
    random.sample(FILEPATHS_NUMPY_CK_TEST, int(CK_TEST_SPLIT*len(FILEPATHS_NUMPY_CK_TEST)))
